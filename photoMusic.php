...
<title>The Design Work of Nick Biewer - Music Photography</title>
...
<div id="full">
  ...
  <span class="bottomNav">
  	<div class="topNav">
            	<a href="photoMain.php">studio</a> || 
                <a href="photoScenery.php">scenery</a> ||
                <a href="photoMusic.php">music</a> ||
                <a href="photoNightlife.php">nightlife</a>
            </div>     
     ...
     <div id="container">
   	 <div class="large-col-left">
     	<span class="headers"> music photography </span>
        <div class="divider"><p style="line-height: 0px;"></p></div>
        <div class="flickrPics">
        
        

<div id="PictoBrowser110519025129">Get the flash player here: http://www.adobe.com/flashplayer</div><script type="text/javascript" src="http://www.db798.com/pictobrowser/swfobject.js"></script><script type="text/javascript"> var so = new SWFObject("http://www.db798.com/pictobrowser.swf", "PictoBrowser", "600", "630", "8", "#ffffff"); so.addVariable("source", "sets"); so.addVariable("names", "Music"); so.addVariable("userName", "nick biewer photography"); so.addVariable("userId", "63056571@N04"); so.addVariable("ids", "72157626755055920"); so.addVariable("titles", "on"); so.addVariable("displayNotes", "on"); so.addVariable("thumbAutoHide", "off"); so.addVariable("imageSize", "medium"); so.addVariable("vAlign", "mid"); so.addVariable("vertOffset", "0"); so.addVariable("colorHexVar", "ffffff"); so.addVariable("initialScale", "off"); so.addVariable("bgAlpha", "90"); so.write("PictoBrowser110519025129");	</script>
        ...
        <div class="right-col">
            	<span class="headers"> about </span>
        <div class="divider"><p style="line-height: 0px;"></p></div>
       		<div class="homeText">
            <p class="homeAbout">
            
           Music has been one of the most influential things throughout my whole life. A lot of my imaging work is made with the idea that it could be used as promotional material for musicians.  <br><br> When I have the opportunity, I explore the different style of trying to catch music in action. 
     ...
     <div id="footer">
        ...
        <div id="footerNav">
        	<span class="bottomNav">
                ...
                <a href="imagingMain.php">[imaging]</a>
