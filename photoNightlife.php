...
<title>The Design Work of Nick Biewer - Nightlife</title>
  ...
  <span class="bottomNav">
     ...
     <div id="container">
   	 <div class="large-col-left">
     	<span class="headers"> nightlife photography study</span>
...
<div id="PictoBrowser110519031322">Get the flash player here: http://www.adobe.com/flashplayer</div><script type="text/javascript" src="http://www.db798.com/pictobrowser/swfobject.js"></script><script type="text/javascript"> var so = new SWFObject("http://www.db798.com/pictobrowser.swf", "PictoBrowser", "600", "550", "8", "#ffffff"); so.addVariable("source", "sets"); so.addVariable("names", "Nightlife"); so.addVariable("userName", "nick biewer photography"); so.addVariable("userId", "63056571@N04"); so.addVariable("ids", "72157626755143546"); so.addVariable("titles", "on"); so.addVariable("displayNotes", "on"); so.addVariable("thumbAutoHide", "off"); so.addVariable("imageSize", "medium"); so.addVariable("vAlign", "mid"); so.addVariable("vertOffset", "0"); so.addVariable("colorHexVar", "ffffff"); so.addVariable("initialScale", "off"); so.addVariable("bgAlpha", "90"); so.write("PictoBrowser110519031322");	</script>
        ...
        <div class="divider"><p style="line-height: 0px;"></p></div>
          ...
          This is a study I did in 2009 about the use of artificial light in night photography. There were no flashes used, all photos were taken with long exposures on a tripod. <br>
<br>  The contrast between the scenes and the lighting surrounding them seem to give a calming feel to these photos. 
