...
<title>The Design Work of Nick Biewer - Fine Arts</title>
  ...
  <span class="bottomNav">
     ...
     <div id="container">
   	 <div class="large-col-left">
     	<span class="headers"> fine arts</span>
...
<div id="PictoBrowser110521014347">Get the flash player here: http://www.adobe.com/flashplayer</div><script type="text/javascript" src="http://www.db798.com/pictobrowser/swfobject.js"></script><script type="text/javascript"> var so = new SWFObject("http://www.db798.com/pictobrowser.swf", "PictoBrowser", "600", "600", "8", "#ffffff"); so.addVariable("source", "sets"); so.addVariable("names", "Fine Arts"); so.addVariable("userName", "nick biewer photography"); so.addVariable("userId", "63056571@N04"); so.addVariable("ids", "72157626643874773"); so.addVariable("titles", "on"); so.addVariable("displayNotes", "on"); so.addVariable("thumbAutoHide", "off"); so.addVariable("imageSize", "medium"); so.addVariable("vAlign", "mid"); so.addVariable("vertOffset", "0"); so.addVariable("colorHexVar", "ffffff"); so.addVariable("initialScale", "off"); so.addVariable("bgAlpha", "90"); so.write("PictoBrowser110521014347");	</script>
        ...
        <div class="divider"><p style="line-height: 0px;"></p></div>
          ...
          The reason I entered the art world.  I started drawing at a young age and found I had a talent for it.  Although I focus more on digital medias these days, I still sketch out my ideas before bringing them onto computers. 
