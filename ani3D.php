...
<title>The Design Work of Nick Biewer - 3D Animation</title>
...
<div id="full">
  ...
  <div id="lBar"> 
    <span class="bottomNav">
  	<div class="topNav">
           <a href="aniMain.php">2D animation</a> || 
                <a href="ani3D.php">3D animation</a>
            </div>     
     ...
     <div id="container">
   	 <div class="large-col-left">
     	<span class="headers"> 3D animation </span>
...
<div id="PictoBrowser110601000000">Get the flash player here: http://www.adobe.com/flashplayer</div><script type="text/javascript" src="http://www.db798.com/pictobrowser/swfobject.js"></script><script type="text/javascript"> var so = new SWFObject("http://www.db798.com/pictobrowser.swf", "PictoBrowser", "600", "500", "8", "#ffffff"); so.addVariable("source", "sets"); so.addVariable("names", "3D Animation"); so.addVariable("userName", "nick biewer photography"); so.addVariable("userId", "63056571@N04"); so.addVariable("ids", "72157626857050310"); so.addVariable("titles", "on"); so.addVariable("displayNotes", "on"); so.addVariable("thumbAutoHide", "off"); so.addVariable("imageSize", "medium"); so.addVariable("vAlign", "mid"); so.addVariable("vertOffset", "0"); so.addVariable("colorHexVar", "ffffff"); so.addVariable("initialScale", "off"); so.addVariable("bgAlpha", "90"); so.write("PictoBrowser110601000000");	</script>
        ...
        <div class="divider"><p style="line-height: 0px;"></p></div>
          ...
          These images are renderings of 3D models I have built in Autodesk Maya. They were designed with the idea that they may be used for video gaming or animated movie purposes. <br><br> Below is a movie I created using a model I built, rigged, and animated.<br><br>
          
           <ul id="aniThumbs">
        
        	<li>
            	
     <a href="images//jumper/jumper.mov" rel="qtposter" loop="true" target="_blank">

                        	<img class="photoshome" border="0" src="imagesNew/jumper.jpg">
                            </a>
                            <br>
                            <span class="titles"> 
                            Jumper </span><br><br>
