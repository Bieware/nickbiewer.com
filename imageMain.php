...
<title>The Design Work of Nick Biewer - About</title>
  ...
  <div id="lBar"> 
     ...
     <div id="container">
   	 <div class="large-col-left">
     	<span class="headers"> scenic photography </span>
        <div class="divider"><p style="line-height: 0px;"></p></div>
        <div class="flickrPics">
        
        

<div id="PictoBrowser110519004025">Get the flash player here: http://www.adobe.com/flashplayer</div><script type="text/javascript" src="http://www.db798.com/pictobrowser/swfobject.js"></script><script type="text/javascript"> var so = new SWFObject("http://www.db798.com/pictobrowser.swf", "PictoBrowser", "640", "600", "8", "#ffffff"); so.addVariable("source", "sets"); so.addVariable("names", "Scenery"); so.addVariable("userName", "nick biewer photography"); so.addVariable("userId", "63056571@N04"); so.addVariable("ids", "72157626629734127"); so.addVariable("titles", "on"); so.addVariable("displayNotes", "on"); so.addVariable("thumbAutoHide", "off"); so.addVariable("imageSize", "medium"); so.addVariable("vAlign", "mid"); so.addVariable("vertOffset", "0"); so.addVariable("colorHexVar", "ffffff"); so.addVariable("initialScale", "off"); so.addVariable("bgAlpha", "100"); so.write("PictoBrowser110519004025");	</script>
        ...
        <div class="right-col">
            	<span class="headers"> allies </span>
        <div class="divider"><p style="line-height: 0px;"></p></div>
       		<div class="allies">
            
           <a href="http://www.kevkeane.com"><span class="titlesLg"> Kevin Keane </span></a> 
            	<p> Designer and Photographer <br><br> </p>
               
                
             <a href="http://www.facebook.com/BattlegroundStudios"><span class="titlesLg"> Battleground Studios </span> </a>
             <p> Recording Studio in DC <br><br>
			</p>
             
            
            <a href="http://www.facebook.com/Logundubstep"><span class="titlesLg"> Logun </span> </a>
            <p> Musical Artist<br><br></p>
